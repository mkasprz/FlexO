...
public class ThreeDimensionalSetupBuilder implements SetupBuilder {
    ...
    public Setup build(int numberOfNodesInBase) {
        ...
        for (double k = 0; k < Math.PI / 2; k += stepSize) {
            ...
            connections.add(new Connection(typicalNode1, nodes.get(0), 0, SetupBuilder.getDistanceBetweenNodes(typicalNode1, nodes.get(0)), SetupBuilder.getDistanceOnCoordinate(typicalNode1, nodes.get(0), 0), SetupBuilder.getDistanceOnCoordinate(typicalNode1, nodes.get(0), 1), SetupBuilder.getDistanceOnCoordinate(typicalNode1, nodes.get(0), 2)));
        }
